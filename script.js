...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>Wayne Ndlovu</a>.</span><br><br>I am a front end developer with 7 years experience <span class='bold'> I have a Bachelors degree in computer science 👨🏻‍💻📚</span><br><br>I am eager to hear about potential career opportunities, so I would be pleased to chat about job openings in the engineering sphere.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "help":
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I have obtained a Bachelors degree in computer science .<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br><br>C<br>PHP<br><br>React.js<br>Python<br>CSS<br>HTML</span><br><br>I have experiance with following frameworks :<span class='bold'><br>Android<br>Flutter<br><br>Wordpress<br>Webflow<br>Drupal<brReactJs<br></span><br><br>I use <span class='bold'>Arch Linux</span> as daily <br>DE:Gnome(More often) Kde(often)<br>Favourite IDE:VSCode</span>");
            break;

        case "education":
            sendTextMessage("I Have completed a degree in computer science currently pusuing Accredited Certifications from Google, Microsoft and Amazon<br>Passing Year : 2016<br><br>I have completed my Diploma in Information Mangement<br>Passing Year:2015<br>Result:86.06%<br><br>I have completed my Secondary school at Queens High School and obtained my grade 12 NSC certificationSWV<br>Passing Year:2011");
            break;
        ...
        case "clear":
            ...
            break;
        case "about":
            sendTextMessage("🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed by Wayne Ndlovu <a class='alink' target='_blank' href='https:\/\/instagram.com/vinayak_patil_09/'><span class='bold'>Wayne Ndlovu</a> with ❤️</span>");
            break;
        case "contact":
            sendTextMessage(contactString);
            break;
        case "projects":
            sendTextMessage("You want to check my projects? Then just jump into my Linktree Account.<br><br><div class='social'><a target='_blank' href='https://linktr.ee/geforex93'> <div class='socialItem'><img class='socialItemI' src='images/github.svg' alt=''></div> </a></div>");
            break;
        case "new":
            sendTextMessage(addressString);
            break;
